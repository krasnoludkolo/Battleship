...
public class Bot extends AbstractBot {
    ...
    private Coordinates getCoordinates() {
        ...
        if (lastMoveResult.getActionResult() != ActionResult.OUT_OF_BOARD) {
            lastShot = lastShotTmp;
        }
